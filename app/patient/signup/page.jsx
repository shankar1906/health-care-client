...
export default function PatientSignupPage() {
    ...
    return (
        ...
        >
            <Card className="w-[700px] bg-white p-6 rounded-lg shadow-lg flex flex-col justify-center">
                <CardHeader>
                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        ...
                        <div className="flex justify-between gap-3">
                            ...
                            <div className="w-1/2">
                                ...
                                <Input id="medicalHistory" placeholder="E.g., Asthma, Diabetes" value={formData.medicalHistory} onChange={handleChange} />
                            </div>
                        </div>
